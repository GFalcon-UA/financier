...
package ua.com.gfalcon.financier.core.budget;
...
public class SaverCalculatorTest {
    ...
    public void testRegular() {
        ...
        Assertions.assertArrayEquals(expectedPlan.toArray(new FinancePlanEntry[0]),
    ...
    public void testSetNullPlan() {
        ...
        Assertions.assertFalse(calculator.setPreparedPlan(new ArrayList<>()));
        Assertions.assertArrayEquals(plan.toArray(new FinancePlanEntry[0]), calculator.getPlan()
