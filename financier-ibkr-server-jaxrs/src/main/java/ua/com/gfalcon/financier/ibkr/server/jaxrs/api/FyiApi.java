...
import ua.com.gfalcon.financier.ibkr.server.jaxrs.api.factories.FyiApiServiceFactory;
...
public class FyiApi {
    ...
    @io.swagger.annotations.ApiResponses(value = {@io.swagger.annotations.ApiResponse(code = 200,
            ...
            response = Object.class)})
    public Response fyiNotificationsNotificationIdPut(@ApiParam(value = "mark a notification read",
            required = true) @PathParam("notificationId") String notificationId,
            @Context SecurityContext securityContext) throws NotFoundException {
