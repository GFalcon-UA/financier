...
import ua.com.gfalcon.financier.ibkr.server.jaxrs.api.CcpApiService;
...
public class CcpApiServiceImpl extends CcpApiService {
    ...
    @Override
    public Response ccpOrderDelete(@NotNull String acct, @NotNull BigDecimal id,
            SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok()
                .entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!"))
    ...
    @Override
    public Response ccpOrderPut(@NotNull String acct, @NotNull BigDecimal id,
            SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok()
                .entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!"))
    ...
    @Override
    public Response ccpOrdersGet(@NotNull String acct, Boolean cancelled,
            SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok()
                .entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!"))
