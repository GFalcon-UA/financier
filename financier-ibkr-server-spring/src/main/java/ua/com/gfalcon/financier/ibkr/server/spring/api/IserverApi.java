...
public interface IserverApi {
    ...
    @ApiOperation(value = "Activate or deactivate an alert",
            nickname = "iserverAccountAccountIdAlertActivatePost",
    ...
    @RequestMapping(value = "/iserver/account/{accountId}/alert/activate",
    ...
    @ApiOperation(value = "Delete an alert",
            nickname = "iserverAccountAccountIdAlertAlertIdDelete",
            notes = "Please be careful, if alertId is 0, it will delete all alerts",
            response = Object.class,
            tags = {"Alert",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns an object", response = Object.class)})
    @RequestMapping(value = "/iserver/account/{accountId}/alert/{alertId}",
            produces = {"application/json"},
    ...
    @ApiOperation(value = "Create or modify alert",
            nickname = "iserverAccountAccountIdAlertPost",
            notes = "Please note here, DO NOT pass orderId when creating a new alert, toolId is only required for MTA alert ",
            response = Object.class,
            tags = {"Alert",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns an object", response = Object.class)})
    @RequestMapping(value = "/iserver/account/{accountId}/alert",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Get a list of available alerts",
            nickname = "iserverAccountAccountIdAlertsGet",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class,
            responseContainer = "List")})
    @RequestMapping(value = "/iserver/account/{accountId}/alerts",
            produces = {"application/json"},
    ...
    @ApiOperation(value = "Cancel Order",
            nickname = "iserverAccountAccountIdOrderOrderIdDelete",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class)})
    @RequestMapping(value = "/iserver/account/{accountId}/order/{orderId}",
            produces = {"application/json"},
            method = RequestMethod.DELETE)
    ...
    @ApiOperation(value = "Modify Order",
            nickname = "iserverAccountAccountIdOrderOrderIdPost",
    ...
    @ApiOperation(value = "Place Order (Deprecated)",
            nickname = "iserverAccountAccountIdOrderPost",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class,
            responseContainer = "List")})
    @RequestMapping(value = "/iserver/account/{accountId}/order",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Preview Order (Deprecated)",
            nickname = "iserverAccountAccountIdOrderWhatifPost",
            ...
            tags = {"Order",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns an object", response = Object.class)})
    @RequestMapping(value = "/iserver/account/{accountId}/order/whatif",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Place Orders",
            nickname = "iserverAccountAccountIdOrdersPost",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class,
            responseContainer = "List")})
    @RequestMapping(value = "/iserver/account/{accountId}/orders",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Preview Orders",
            nickname = "iserverAccountAccountIdOrdersWhatifPost",
            ...
            tags = {"Order",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns an object", response = Object.class)})
    @RequestMapping(value = "/iserver/account/{accountId}/orders/whatif",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Get details of an alert",
            nickname = "iserverAccountAlertIdGet",
    ...
    @ApiOperation(value = "Get MTA alert",
            nickname = "iserverAccountMtaGet",
    ...
    @ApiOperation(value = "Order Status",
            nickname = "iserverAccountOrderStatusOrderIdGet",
            notes = "",
            response = OrderStatus.class,
            tags = {"Order",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "returns an object", response = OrderStatus.class)})
    @RequestMapping(value = "/iserver/account/order/status/{orderId}",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<OrderStatus> iserverAccountOrderStatusOrderIdGet(
            @ApiParam(value = "Customer order id, use /iservers/account/orders endpoint to query orderId.",
                    required = true) @PathVariable("orderId") String orderId);


    @ApiOperation(value = "Place Orders for FA",
            nickname = "iserverAccountOrdersFaGroupPost",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class,
            responseContainer = "List")})
    @RequestMapping(value = "/iserver/account/orders/{faGroup}",
            produces = {"application/json"},
            method = RequestMethod.POST)
    ...
    @ApiOperation(value = "Live Orders",
            nickname = "iserverAccountOrdersGet",
    ...
    @ApiOperation(value = "PnL for the selected account",
            nickname = "iserverAccountPnlPartitionedGet",
    ...
    @ApiOperation(value = "List of Trades for the selected account",
            nickname = "iserverAccountTradesGet",
    ...
    @ApiOperation(value = "Authentication Status",
            nickname = "iserverAuthStatusPost",
    ...
    @ApiOperation(value = "IB Algo Params",
            nickname = "iserverContractConidAlgosGet",
    ...
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class,
            responseContainer = "List")})
    @RequestMapping(value = "/iserver/contract/{conid}/algos",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ...
    @ApiOperation(value = "Info and Rules",
            nickname = "iserverContractConidInfoAndRulesGet",
    ...
    @RequestMapping(value = "/iserver/contract/{conid}/info-and-rules",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ...
    @ApiOperation(value = "Contract Details",
            nickname = "iserverContractConidInfoGet",
    ...
    @RequestMapping(value = "/iserver/contract/{conid}/info",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ...
    @ApiOperation(value = "Contract Rules",
            nickname = "iserverContractRulesPost",
    ...
    @ApiOperation(value = "Market Data History",
            nickname = "iserverMarketdataHistoryGet",
    ...
    @ApiOperation(value = "Market Data",
            nickname = "iserverMarketdataSnapshotGet",
    ...
    ResponseEntity<List<Object>> iserverMarketdataSnapshotGet(
    ...
    @ApiOperation(value = "Tries to re-authenticate to Brokerage",
            nickname = "iserverReauthenticatePost",
    ...
    @ApiOperation(value = "Place Order Reply",
            nickname = "iserverReplyReplyidPost",
    ...
    ResponseEntity<List<Object>> iserverReplyReplyidPost(
    ...
    @ApiOperation(value = "Secdef Info",
            nickname = "iserverSecdefInfoGet",
    ...
    @ApiOperation(value = "Search by Symbol or Name",
            nickname = "iserverSecdefSearchPost",
    ...
    ResponseEntity<List<Object>> iserverSecdefSearchPost(@ApiParam(value = "Symbol or Company Name to be searched",
            required = true) @Valid @RequestBody Symbol symbol);


    @ApiOperation(value = "Search Strikes",
            nickname = "iserverSecdefStrikesGet",
