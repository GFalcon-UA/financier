...
public interface PaApi {
    ...
    @ApiOperation(value = "Account Performance",
            nickname = "paPerformancePost",
    ...
    @ApiOperation(value = "Account Balance's Summary",
            nickname = "paSummaryPost",
    ...
    @ApiOperation(value = "Position's Transaction History",
            nickname = "paTransactionsPost",
