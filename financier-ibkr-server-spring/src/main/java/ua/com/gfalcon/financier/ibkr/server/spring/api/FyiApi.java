...
public interface FyiApi {
    ...
    @ApiOperation(value = "Enable/Disable device option",
            nickname = "fyiDeliveryoptionsDevicePost",
            notes = "",
            response = Object.class,
            tags = {"FYI",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "200 means successful", response = Object.class)})
    ...
    @ApiOperation(value = "Enable/Disable email option",
            nickname = "fyiDeliveryoptionsEmailPut",
            notes = "",
            response = Object.class,
            tags = {"FYI",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "200 means successful", response = Object.class)})
    ...
    @ApiOperation(value = "Get delivery options",
            nickname = "fyiDeliveryoptionsGet",
    ...
    @ApiOperation(value = "Get disclaimer for a certain kind of fyi",
            nickname = "fyiDisclaimerTypecodeGet",
            notes = "",
            response = Object.class,
            tags = {"FYI",})
    ...
    ResponseEntity<Object> fyiDisclaimerTypecodeGet(@ApiParam(value = "fyi code, for example --M8, EA",
            required = true) @PathVariable("typecode") String typecode);


    @ApiOperation(value = "Mark disclaimer read",
            nickname = "fyiDisclaimerTypecodePut",
            notes = "",
            response = Object.class,
            tags = {"FYI",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "200 means successful", response = Object.class)})
    @RequestMapping(value = "/fyi/disclaimer/{typecode}", produces = {"application/json"}, method = RequestMethod.PUT)
    ResponseEntity<Object> fyiDisclaimerTypecodePut(@ApiParam(value = "fyi code, for example --M8, EA",
            required = true) @PathVariable("typecode") String typecode);


    @ApiOperation(value = "Get a list of notifications",
            nickname = "fyiNotificationsGet",
            notes = "",
    ...
    ResponseEntity<Notifications> fyiNotificationsGet(@NotNull @ApiParam(value = "max number of fyis in response",
    ...
    @ApiOperation(value = "Get more notifications based on a certain one",
            nickname = "fyiNotificationsMoreGet",
            notes = "",
            response = Notifications.class,
            tags = {"FYI",})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "An array", response = Notifications.class)})
    ...
    @ApiOperation(value = "Get a list of notifications",
            nickname = "fyiNotificationsNotificationIdPut",
            notes = "",
            response = Object.class,
            tags = {"FYI",})
    @ApiResponses(value = {@ApiResponse(code = 200,
            ...
            response = Object.class)})
    @RequestMapping(value = "/fyi/notifications/{notificationId}",
            produces = {"application/json"},
            method = RequestMethod.PUT)
    ResponseEntity<Object> fyiNotificationsNotificationIdPut(@ApiParam(value = "mark a notification read",
            required = true) @PathVariable("notificationId") String notificationId);


    @ApiOperation(value = "Get a list of subscriptions",
            nickname = "fyiSettingsGet",
    ...
    @ApiOperation(value = "Enable/Disable certain subscription",
            nickname = "fyiSettingsTypecodePost",
    ...
    @ApiOperation(value = "Get unread number of fyis. The HTTP method POST is also supported.",
            nickname = "fyiUnreadnumberGet",
