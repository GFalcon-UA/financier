...
public interface TrsrvApi {
    ...
    @ApiOperation(value = "Security Futures by Symbol",
            nickname = "trsrvFuturesGet",
    ...
    ResponseEntity<Object> trsrvFuturesGet(
    ...
    @ApiOperation(value = "Secdef by Conid",
            nickname = "trsrvSecdefPost",
    ...
    @ApiOperation(value = "Get trading schedule for symbol",
            nickname = "trsrvSecdefScheduleGet",
    ...
    ResponseEntity<Object> trsrvSecdefScheduleGet(
    ...
    @ApiOperation(value = "Security Stocks by Symbol",
            nickname = "trsrvStocksGet",
    ...
    ResponseEntity<Object> trsrvStocksGet(
