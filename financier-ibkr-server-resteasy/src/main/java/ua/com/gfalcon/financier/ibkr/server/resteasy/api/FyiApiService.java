...
public interface FyiApiService {
    Response fyiDeliveryoptionsDeviceIdDelete(String deviceId,
    ...
    Response fyiNotificationsGet(String max, String exclude, String include,
            SecurityContext securityContext) throws NotFoundException;

    Response fyiNotificationsMoreGet(String id, SecurityContext securityContext) throws NotFoundException;

    Response fyiNotificationsNotificationIdPut(String notificationId,
            SecurityContext securityContext) throws NotFoundException;

    Response fyiSettingsGet(SecurityContext securityContext) throws NotFoundException;

    Response fyiSettingsTypecodePost(String typecode, Body body,
            SecurityContext securityContext) throws NotFoundException;
