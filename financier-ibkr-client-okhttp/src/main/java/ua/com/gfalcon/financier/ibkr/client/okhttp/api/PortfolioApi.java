...
public class PortfolioApi {
    ...
    public com.squareup.okhttp.Call portfolioAccountIdAllocationGetCall(String accountId,
        ...
        String localVarPath = "/portfolio/{accountId}/allocation".replaceAll("\\{" + "accountId" + "\\}",
    ...
    public com.squareup.okhttp.Call portfolioAccountIdPositionConidGetCall(String accountId, Integer conid,
        ...
        // create path and map variables
        String localVarPath = "/portfolio/{accountId}/position/{conid}".replaceAll("\\{" + "accountId" + "\\}",
                        apiClient.escapeString(accountId.toString()))
    ...
    private com.squareup.okhttp.Call portfolioAccountIdPositionConidGetValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling portfolioAccountIdPositionConidGet(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Position> portfolioAccountIdPositionConidGetWithHttpInfo(String accountId,
            Integer conid) throws ApiException {
    ...
    public com.squareup.okhttp.Call portfolioAccountIdPositionsInvalidatePostCall(String accountId,
        ...
        // create path and map variables
        String localVarPath = "/portfolio/{accountId}/positions/invalidate".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
    ...
    private com.squareup.okhttp.Call portfolioAccountIdPositionsInvalidatePostValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling portfolioAccountIdPositionsInvalidatePost(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> portfolioAccountIdPositionsInvalidatePostWithHttpInfo(
    ...
    public com.squareup.okhttp.Call portfolioAccountIdPositionsPageIdGetCall(String accountId, String pageId,
        ...
        // create path and map variables
        String localVarPath = "/portfolio/{accountId}/positions/{pageId}".replaceAll("\\{" + "accountId" + "\\}",
                        apiClient.escapeString(accountId.toString()))
                .replaceAll("\\{" + "pageId" + "\\}", apiClient.escapeString(pageId.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (model != null) localVarQueryParams.addAll(apiClient.parameterToPair("model", model));
        if (sort != null) localVarQueryParams.addAll(apiClient.parameterToPair("sort", sort));
        if (direction != null) localVarQueryParams.addAll(apiClient.parameterToPair("direction", direction));
        if (period != null) localVarQueryParams.addAll(apiClient.parameterToPair("period", period));
    ...
    private com.squareup.okhttp.Call portfolioAccountIdPositionsPageIdGetValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling portfolioAccountIdPositionsPageIdGet(Async)");
        }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call portfolioAllocationPostAsync(Body body,
            final ApiCallback<Allocation> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call portfolioAllocationPostCall(Body body,
        ...
        // create path and map variables
        String localVarPath = "/portfolio/allocation";
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call portfolioPositionsConidGetAsync(Integer conid,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call portfolioPositionsConidGetCall(Integer conid,
        ...
        // create path and map variables
        String localVarPath = "/portfolio/positions/{conid}".replaceAll("\\{" + "conid" + "\\}",
