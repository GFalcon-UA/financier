...
public class CcpBetaApi {
    ...
    public com.squareup.okhttp.Call ccpAccountGetCall(final ProgressResponseBody.ProgressListener progressListener,
        ...
        String localVarPath = "/ccp/account";
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object ccpAuthInitPost(Boolean compete, String locale, String mac, String machineId,
    ...
    public com.squareup.okhttp.Call ccpAuthInitPostCall(Boolean compete, String locale, String mac, String machineId,
        ...
        // create path and map variables
        String localVarPath = "/ccp/auth/init";
        ...
        Map<String, Object> localVarFormParams = new HashMap<String, Object>();
        if (compete != null) localVarFormParams.put("compete", compete);
        if (locale != null) localVarFormParams.put("locale", locale);
        if (mac != null) localVarFormParams.put("mac", mac);
        if (machineId != null) localVarFormParams.put("machineId", machineId);
        if (username != null) localVarFormParams.put("username", username);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ccpAuthResponsePostAsync(Auth auth,
    ...
    public com.squareup.okhttp.Call ccpAuthResponsePostCall(Auth auth,
        ...
        // create path and map variables
        String localVarPath = "/ccp/auth/response";
    ...
    public com.squareup.okhttp.Call ccpOrderDeleteCall(String acct, BigDecimal id,
        ...
        // create path and map variables
        String localVarPath = "/ccp/order";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (acct != null) localVarQueryParams.addAll(apiClient.parameterToPair("acct", acct));
    ...
    public com.squareup.okhttp.Call ccpOrderPostCall(String acct, BigDecimal conid, String ccy, String exchange,
        ...
        if (ccy != null) localVarQueryParams.addAll(apiClient.parameterToPair("ccy", ccy));
        if (exchange != null) localVarQueryParams.addAll(apiClient.parameterToPair("exchange", exchange));
        if (qty != null) localVarQueryParams.addAll(apiClient.parameterToPair("qty", qty));
        if (type != null) localVarQueryParams.addAll(apiClient.parameterToPair("type", type));
        if (side != null) localVarQueryParams.addAll(apiClient.parameterToPair("side", side));
        if (price != null) localVarQueryParams.addAll(apiClient.parameterToPair("price", price));
        if (tif != null) localVarQueryParams.addAll(apiClient.parameterToPair("tif", tif));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ccpOrderPutAsync(String acct, BigDecimal id,
            final ApiCallback<OrderData> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call ccpOrdersGetCall(String acct, Boolean cancelled,
        ...
        // create path and map variables
        String localVarPath = "/ccp/orders";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (acct != null) localVarQueryParams.addAll(apiClient.parameterToPair("acct", acct));
        if (cancelled != null) localVarQueryParams.addAll(apiClient.parameterToPair("cancelled", cancelled));
    ...
    public com.squareup.okhttp.Call ccpPositionsGetCall(final ProgressResponseBody.ProgressListener progressListener,
        ...
        // create path and map variables
        String localVarPath = "/ccp/positions";
    ...
    public com.squareup.okhttp.Call ccpStatusGetCall(final ProgressResponseBody.ProgressListener progressListener,
        ...
        // create path and map variables
        String localVarPath = "/ccp/status";
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ccpTradesGetAsync(String from, String to,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call ccpTradesGetCall(String from, String to,
        ...
        // create path and map variables
        String localVarPath = "/ccp/trades";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (from != null) localVarQueryParams.addAll(apiClient.parameterToPair("from", from));
        if (to != null) localVarQueryParams.addAll(apiClient.parameterToPair("to", to));
