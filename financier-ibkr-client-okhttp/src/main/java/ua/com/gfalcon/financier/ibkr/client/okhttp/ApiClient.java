...
package ua.com.gfalcon.financier.ibkr.client.okhttp;
...
import okio.Okio;
import ua.com.gfalcon.financier.ibkr.client.okhttp.auth.ApiKeyAuth;
import ua.com.gfalcon.financier.ibkr.client.okhttp.auth.Authentication;
import ua.com.gfalcon.financier.ibkr.client.okhttp.auth.HttpBasicAuth;
import ua.com.gfalcon.financier.ibkr.client.okhttp.auth.OAuth;
...
public class ApiClient {
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        String respBody;
        try {
            if (response.body() != null) respBody = response.body()
                    .string();
            else respBody = null;
        } catch (IOException e) {
            throw new ApiException(e);
    ...
    public File prepareDownloadFile(Response response) throws IOException {
        ...
        if (tempFolderPath == null) return Files.createTempFile(prefix, suffix)
                .toFile();
        else return Files.createTempFile(Paths.get(tempFolderPath), prefix, suffix)
                .toFile();
    }
