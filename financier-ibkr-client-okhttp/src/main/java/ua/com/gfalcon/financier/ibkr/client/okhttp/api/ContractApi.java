...
public class ContractApi {
    ...
    public com.squareup.okhttp.Call iserverContractConidAlgosGetCall(String conid, String algos, String addDescription,
        ...
        String localVarPath = "/iserver/contract/{conid}/algos".replaceAll("\\{" + "conid" + "\\}",
                apiClient.escapeString(conid.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (algos != null) localVarQueryParams.addAll(apiClient.parameterToPair("algos", algos));
        if (addDescription != null) localVarQueryParams.addAll(
                apiClient.parameterToPair("addDescription", addDescription));
        if (addParams != null) localVarQueryParams.addAll(apiClient.parameterToPair("addParams", addParams));
    ...
    public com.squareup.okhttp.Call iserverContractConidInfoAndRulesGetCall(String conid, Boolean isBuy,
        ...
        // create path and map variables
        String localVarPath = "/iserver/contract/{conid}/info-and-rules".replaceAll("\\{" + "conid" + "\\}",
                apiClient.escapeString(conid.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (isBuy != null) localVarQueryParams.addAll(apiClient.parameterToPair("isBuy", isBuy));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverContractConidInfoAndRulesGetWithHttpInfo(String conid,
            Boolean isBuy) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverContractConidInfoGetAsync(String conid,
            final ApiCallback<Contract> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverContractConidInfoGetCall(String conid,
        ...
        // create path and map variables
        String localVarPath = "/iserver/contract/{conid}/info".replaceAll("\\{" + "conid" + "\\}",
                apiClient.escapeString(conid.toString()));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverContractRulesPostAsync(Conid conid,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverSecdefInfoGetAsync(String conid, String sectype, String month,
            String exchange, String strike, String right,
            final ApiCallback<List<SecdefInfo>> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverSecdefInfoGetCall(String conid, String sectype, String month,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (conid != null) localVarQueryParams.addAll(apiClient.parameterToPair("conid", conid));
        if (sectype != null) localVarQueryParams.addAll(apiClient.parameterToPair("sectype", sectype));
        if (month != null) localVarQueryParams.addAll(apiClient.parameterToPair("month", month));
        if (exchange != null) localVarQueryParams.addAll(apiClient.parameterToPair("exchange", exchange));
        if (strike != null) localVarQueryParams.addAll(apiClient.parameterToPair("strike", strike));
        if (right != null) localVarQueryParams.addAll(apiClient.parameterToPair("right", right));
    ...
    public com.squareup.okhttp.Call iserverSecdefSearchPostCall(Symbol symbol,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = symbol;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object iserverSecdefStrikesGet(String conid, String sectype, String month,
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call trsrvFuturesGetAsync(String symbols,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call trsrvFuturesGetCall(String symbols,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (symbols != null) localVarQueryParams.addAll(apiClient.parameterToPair("symbols", symbols));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call trsrvSecdefPostAsync(Body body,
            final ApiCallback<Secdef> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object trsrvSecdefScheduleGet(String assetClass, String symbol, String exchange,
    ...
    public com.squareup.okhttp.Call trsrvSecdefScheduleGetCall(String assetClass, String symbol, String exchange,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (assetClass != null) localVarQueryParams.addAll(apiClient.parameterToPair("assetClass", assetClass));
        if (symbol != null) localVarQueryParams.addAll(apiClient.parameterToPair("symbol", symbol));
        if (exchange != null) localVarQueryParams.addAll(apiClient.parameterToPair("exchange", exchange));
        if (exchangeFilter != null) localVarQueryParams.addAll(
                apiClient.parameterToPair("exchangeFilter", exchangeFilter));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call trsrvStocksGetAsync(String symbols,
            final ApiCallback<Object> callback) throws ApiException {
