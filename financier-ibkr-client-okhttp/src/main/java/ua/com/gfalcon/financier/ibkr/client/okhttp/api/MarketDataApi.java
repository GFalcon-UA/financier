...
public class MarketDataApi {
    ...
    public com.squareup.okhttp.Call iserverMarketdataConidUnsubscribeGetCall(String conid,
        ...
        String localVarPath = "/iserver/marketdata/{conid}/unsubscribe".replaceAll("\\{" + "conid" + "\\}",
    ...
    public com.squareup.okhttp.Call iserverMarketdataHistoryGetCall(String conid, String period, String exchange,
        ...
        if (bar != null) localVarQueryParams.addAll(apiClient.parameterToPair("bar", bar));
        if (outsideRth != null) localVarQueryParams.addAll(apiClient.parameterToPair("outsideRth", outsideRth));
    ...
    public com.squareup.okhttp.Call iserverMarketdataSnapshotGetCall(String conids, Integer since, String fields,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (conids != null) localVarQueryParams.addAll(apiClient.parameterToPair("conids", conids));
        if (since != null) localVarQueryParams.addAll(apiClient.parameterToPair("since", since));
        if (fields != null) localVarQueryParams.addAll(apiClient.parameterToPair("fields", fields));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverMarketdataUnsubscribeallGetAsync(
    ...
    public com.squareup.okhttp.Call mdSnapshotGetCall(String conids, String fields,
        ...
        // create path and map variables
        String localVarPath = "/md/snapshot";
