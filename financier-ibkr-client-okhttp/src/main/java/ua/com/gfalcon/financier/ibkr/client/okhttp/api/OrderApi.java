...
public class OrderApi {
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdOrderOrderIdDeleteCall(String accountId, String orderId,
        ...
        String localVarPath = "/iserver/account/{accountId}/order/{orderId}".replaceAll("\\{" + "accountId" + "\\}",
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdOrderOrderIdDeleteValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdOrderOrderIdDelete(Async)");
        }

        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException(
                    "Missing the required parameter 'orderId' when calling iserverAccountAccountIdOrderOrderIdDelete(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverAccountAccountIdOrderOrderIdDeleteWithHttpInfo(String accountId,
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> iserverAccountAccountIdOrderOrderIdPost(String accountId, String orderId,
            ModifyOrder body) throws ApiException {
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdOrderOrderIdPostValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdOrderOrderIdPost(Async)");
        }

        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new ApiException(
                    "Missing the required parameter 'orderId' when calling iserverAccountAccountIdOrderOrderIdPost(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException(
                    "Missing the required parameter 'body' when calling iserverAccountAccountIdOrderOrderIdPost(Async)");
        }
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdOrderPostCall(String accountId, OrderRequest body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/order".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
     ...
     */
    @Deprecated
    public ApiResponse<List<Object>> iserverAccountAccountIdOrderPostWithHttpInfo(String accountId,
            OrderRequest body) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdOrderWhatifPostCall(String accountId, OrderRequest body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/order/whatif".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdOrderWhatifPostValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdOrderWhatifPost(Async)");
        }
     ...
     */
    @Deprecated
    public ApiResponse<Object> iserverAccountAccountIdOrderWhatifPostWithHttpInfo(String accountId,
            OrderRequest body) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdOrdersPostCall(String accountId, Body body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/orders".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> iserverAccountAccountIdOrdersPostWithHttpInfo(String accountId,
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdOrdersWhatifPostCall(String accountId, Body body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/orders/whatif".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdOrdersWhatifPostValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdOrdersWhatifPost(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException(
                    "Missing the required parameter 'body' when calling iserverAccountAccountIdOrdersWhatifPost(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverAccountAccountIdOrdersWhatifPostWithHttpInfo(String accountId,
            Body body) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountOrderStatusOrderIdGetCall(String orderId,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/order/status/{orderId}".replaceAll("\\{" + "orderId" + "\\}",
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OrderStatus> iserverAccountOrderStatusOrderIdGetWithHttpInfo(
            String orderId) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountOrdersFaGroupPostCall(String faGroup, OrderRequest body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/orders/{faGroup}".replaceAll("\\{" + "faGroup" + "\\}",
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> iserverAccountOrdersFaGroupPostWithHttpInfo(String faGroup,
            OrderRequest body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverAccountOrdersGetAsync(Body body,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverReplyReplyidPostCall(String replyid, Body body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/reply/{replyid}".replaceAll("\\{" + "replyid" + "\\}",
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> iserverReplyReplyidPostWithHttpInfo(String replyid,
            Body body) throws ApiException {
