...
public class AlertApi {
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdAlertActivatePostCall(String accountId, Body body,
        ...
        String localVarPath = "/iserver/account/{accountId}/alert/activate".replaceAll("\\{" + "accountId" + "\\}",
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdAlertActivatePostValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdAlertActivatePost(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException(
                    "Missing the required parameter 'body' when calling iserverAccountAccountIdAlertActivatePost(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverAccountAccountIdAlertActivatePostWithHttpInfo(String accountId,
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdAlertAlertIdDeleteCall(String accountId, String alertId,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/alert/{alertId}".replaceAll("\\{" + "accountId" + "\\}",
                        apiClient.escapeString(accountId.toString()))
    ...
    private com.squareup.okhttp.Call iserverAccountAccountIdAlertAlertIdDeleteValidateBeforeCall(String accountId,
        ...
        if (accountId == null) {
            throw new ApiException(
                    "Missing the required parameter 'accountId' when calling iserverAccountAccountIdAlertAlertIdDelete(Async)");
        }

        // verify the required parameter 'alertId' is set
        if (alertId == null) {
            throw new ApiException(
                    "Missing the required parameter 'alertId' when calling iserverAccountAccountIdAlertAlertIdDelete(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverAccountAccountIdAlertAlertIdDeleteWithHttpInfo(String accountId,
            String alertId) throws ApiException {
        com.squareup.okhttp.Call call = iserverAccountAccountIdAlertAlertIdDeleteValidateBeforeCall(accountId, alertId,
                null, null);
        Type localVarReturnType = new TypeToken<Object>() {
        }.getType();
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdAlertPostCall(String accountId, AlertRequest body,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/alert".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> iserverAccountAccountIdAlertPostWithHttpInfo(String accountId,
            AlertRequest body) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountAccountIdAlertsGetCall(String accountId,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/{accountId}/alerts".replaceAll("\\{" + "accountId" + "\\}",
                apiClient.escapeString(accountId.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> iserverAccountAccountIdAlertsGetWithHttpInfo(
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverAccountAlertIdGetAsync(String id,
            final ApiCallback<AlertResponse> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call iserverAccountAlertIdGetCall(String id,
        ...
        // create path and map variables
        String localVarPath = "/iserver/account/alert/{id}".replaceAll("\\{" + "id" + "\\}",
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call iserverAccountMtaGetAsync(
            final ApiCallback<AlertResponse> callback) throws ApiException {
