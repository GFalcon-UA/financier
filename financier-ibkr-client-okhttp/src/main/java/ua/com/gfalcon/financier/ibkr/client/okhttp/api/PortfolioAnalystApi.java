...
public class PortfolioAnalystApi {
     ...
     */
    public com.squareup.okhttp.Call paPerformancePostAsync(Body body,
            final ApiCallback<Performance> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call paSummaryPostAsync(Body body,
            final ApiCallback<Summary> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call paSummaryPostCall(Body body,
        ...
        // create path and map variables
        String localVarPath = "/pa/summary";
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call paTransactionsPostAsync(Body body,
            final ApiCallback<Transactions> callback) throws ApiException {
