...
public class FyiApi {
    ...
    public com.squareup.okhttp.Call fyiDeliveryoptionsDeviceIdDeleteCall(String deviceId,
        ...
        String localVarPath = "/fyi/deliveryoptions/{deviceId}".replaceAll("\\{" + "deviceId" + "\\}",
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fyiDeliveryoptionsDevicePostAsync(Body body,
            final ApiCallback<Object> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fyiDeliveryoptionsEmailPutAsync(String enabled,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call fyiDeliveryoptionsEmailPutCall(String enabled,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (enabled != null) localVarQueryParams.addAll(apiClient.parameterToPair("enabled", enabled));
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fyiDisclaimerTypecodeGetAsync(String typecode,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call fyiDisclaimerTypecodeGetCall(String typecode,
        ...
        // create path and map variables
        String localVarPath = "/fyi/disclaimer/{typecode}".replaceAll("\\{" + "typecode" + "\\}",
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fyiDisclaimerTypecodePutAsync(String typecode,
            final ApiCallback<Object> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call fyiNotificationsGetCall(String max, String exclude, String include,
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (exclude != null) localVarQueryParams.addAll(apiClient.parameterToPair("exclude", exclude));
        if (include != null) localVarQueryParams.addAll(apiClient.parameterToPair("include", include));
        if (max != null) localVarQueryParams.addAll(apiClient.parameterToPair("max", max));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Notifications> fyiNotificationsGetWithHttpInfo(String max, String exclude,
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call fyiNotificationsMoreGetAsync(String id,
            final ApiCallback<Notifications> callback) throws ApiException {
    ...
    public com.squareup.okhttp.Call fyiNotificationsMoreGetCall(String id,
        ...
        // create path and map variables
        String localVarPath = "/fyi/notifications/more";
    ...
    public com.squareup.okhttp.Call fyiNotificationsNotificationIdPutCall(String notificationId,
        ...
        // create path and map variables
        String localVarPath = "/fyi/notifications/{notificationId}".replaceAll("\\{" + "notificationId" + "\\}",
                apiClient.escapeString(notificationId.toString()));
    ...
    private com.squareup.okhttp.Call fyiNotificationsNotificationIdPutValidateBeforeCall(String notificationId,
        ...
        if (notificationId == null) {
            throw new ApiException(
                    "Missing the required parameter 'notificationId' when calling fyiNotificationsNotificationIdPut(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> fyiNotificationsNotificationIdPutWithHttpInfo(
            String notificationId) throws ApiException {
    ...
    public com.squareup.okhttp.Call fyiSettingsTypecodePostCall(String typecode, Body body,
        ...
        // create path and map variables
        String localVarPath = "/fyi/settings/{typecode}".replaceAll("\\{" + "typecode" + "\\}",
                apiClient.escapeString(typecode.toString()));
